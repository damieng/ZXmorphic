...
namespace Test
{
	public partial class CPUForm : Form
	{
		...
		public void RefreshState()
		{
			...
			SetValue(StatusListView, 1, String.Format("{0} {1} {2}", z80.InterruptMode.ToString(), z80.IFF1, z80.IFF2));
		...
		private void RefreshFlags()
		{
			...
			FlagsCheckedListBox.SetItemChecked(3, (z80.F & FlagMask._3) != 0);
			FlagsCheckedListBox.SetItemChecked(4, (z80.F & FlagMask.H) != 0);
			FlagsCheckedListBox.SetItemChecked(5, (z80.F & FlagMask._5) != 0);
		...
		private void CPUForm_VisibleChanged(object sender, System.EventArgs e)
		{
		...
		private void FlagsCheckedListBox_ItemCheck(object sender, ItemCheckEventArgs e)
		{
			switch(e.Index)
			{
				case 0: z80.F ^= FlagMask.C; break;
				case 1: z80.F ^= FlagMask.N; break;
				case 2: z80.F ^= FlagMask.P; break;
				case 3: z80.F ^= FlagMask._3; break;
				case 4: z80.F ^= FlagMask.H; break;
				case 5: z80.F ^= FlagMask._5; break;
				case 6: z80.F ^= FlagMask.Z; break;
				case 7: z80.F ^= FlagMask.S; break;
			}
		}
	}
}